...
export const LootBoxRewardSchema = z.object({
     ...
     */
    rewards: z.array(z.object({ amount: z.coerce.number(), users: z.coerce.number() })),
});
    ...
    z
        ...
        .merge(
            z.object({
                ...
                rewards: z.array(z.object({ amount: z.coerce.number(), users: z.coerce.number() })).nullish(),
            }),
        ),
]);
...
export const CreateCampaignInputSchema = z.object({
     ...
     */
    asymmetricRewards: z.array(AsymmetricRewardSchema.omit({ userPubKey: true, payoutTx: true })).optional(),
    /**
     ...
     */
    origin: z.nativeEnum(CampaignOrigin).optional(),
});
