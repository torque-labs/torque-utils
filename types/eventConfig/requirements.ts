...
export const MemoActionSchema = z.object({
     ...
     */
    fields: z.array(
        z.union([CustomEventStringConfigSchema, CustomEventNumberConfigSchema, CustomEventBooleanConfigSchema]),
    ),
});
...
/**
 * Pump.Fun action schema
 */
export const PumpFunActionSchema = z.object({
    /**
     * The minimum amount of SOL to buy token with (ex: 0.01 $SOL, not lamports)
     */
    solAmount: z.coerce.number(),
    /**
     * The token address to pump
     */
    tokenAddress: z.string(),
});
